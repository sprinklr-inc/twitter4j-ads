...
public final class TwitterFactory implements java.io.Serializable {
    ...
    static {
        ...
        if (ConfigurationContext.getInstance().isGAE()) {
            final String APP_ENGINE_TWITTER_IMPL = "twitter4jads.AppEngineTwitterImpl";
            try {
     ...
     * consumer key and consumer Secret must be provided by twitter4jads.properties, or system properties.<br>
     * Unlike {@link Twitter#setOAuthAccessToken(twitter4jads.auth.AccessToken)}, this factory method potentially returns a cached instance.
     *
