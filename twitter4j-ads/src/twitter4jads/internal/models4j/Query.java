...
public final class Query implements java.io.Serializable {
    ...
    // edit with caution!!!
    // this method is referenced by twitter4jads.internal.json.QueryResultJSONImpl using reflection API in order to make this method invisible to library users
    // you must run twitter4jads.SearchAPITest#testEasyPaging to ensure you're doing right to make any changes to this method
