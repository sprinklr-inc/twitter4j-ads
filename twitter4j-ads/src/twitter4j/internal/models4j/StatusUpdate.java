...
public final class StatusUpdate implements java.io.Serializable {
    ...
    /**
     * only upto 4 mediaIds are allowed
     */
    private List<String> mediaIds;
    private String videoId;
    private String attachmentUrl;

    private Set<String> narrowcastPlaceIds;
    ...
    public Set<String> getNarrowcastPlaceIds() {
        return narrowcastPlaceIds;
    }

    public void setNarrowcastPlaceIds(Set<String> narrowcastPlaceIds) {
        this.narrowcastPlaceIds = narrowcastPlaceIds;
    }

    public StatusUpdate narrowcastPlaceIds(Set<String> narrowcastPlaceIds) {
        setNarrowcastPlaceIds(narrowcastPlaceIds);
        return this;
    }
    ...
    public void setPromotedOnly(boolean promotedOnly) {
    ...
    public boolean equals(Object o) {
        ...
        if (possiblySensitive != that.possiblySensitive) {
            return false;
        }
